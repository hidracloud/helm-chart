...
# hidra: datasource=github-releases depName=kubeval lookupName=instrumenta/kubeval
KUBEVAL_VERSION=v0.16.1

# hidra: datasource=github-releases depName=semver2 lookupName=Ariel-Rodriguez/sh-semversion-2
